'''
    Usage: python3 targeted_simba_attack.py --batch False --folder_path '../images/' --img_path '../images/02.jpeg'   % Single Image Attack
           python3 targeted_simba_attack.py --batch True --folder_path '../images/'                                   % Batch Image Attack
'''
