...
if __name__ == '__main__':
    ...
    adv_img, steps = hop_skip_jump_attack(orig_img_path=orig_img_path, target_img_path=target_img_path, max_iters=2, grad_queries=10, l2_threshold=20, hamming_threshold=17)
